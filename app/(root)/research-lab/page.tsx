...
function page() {
  return (
    <div className=" text-white">
        <div className="w-full border-b border-white/10 shadow-custom shadow-slate-900" >
          <img src="/images/1.png" alt="entropia-research-lab" className="  overflow-hidden  py-2 w-72 xl:w-96 " />
        </div>

          <h2 className=" px-3 py-2 text-[14px] border-b border-white/10 ">Ciencia, tecnología e innovación para impulsar un futuro sostenible</h2>
