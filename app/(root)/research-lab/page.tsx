...
function page() {
  return (
    <div className="">
        <div className="w-full border-b border-white/10 shadow-custom shadow-indigo-800/30" >
          <img src="/images/logorlab.png" alt="entropia-research-lab" className="  overflow-hidden  py-2 w-72 xl:w-96 " />
        </div>
