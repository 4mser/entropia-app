...
function BotonesMapa() {
  ...
  return (
        ...
        <section className='fixed z-50 bottom-14 w-fit right-3 h-fit'>
            <button className='absolute right-0 bottom-3 w-14 h-14 rounded-full overflow-hidden flex justify-center items-center  bg-gradient-to-tr from-blue to-green-600 p-[2px]'>
                    <div className='flex justify-center items-center w-full h-full p-2.5 bg-black/30 backdrop-blur-3xl rounded-full'>
                        <img src="../assets/map-icons/pin.svg" alt="" className='w-full h-full  object-contain' />
                    </div>
            </button>
