...
function PostThreadButton() {
  ...
  return (
    <div className="fixed md:hidden  bottom-20 max-sm:bottom-20 shadow-md right-4 p-px rounded-full bg-gradient-to-tr from-amber-500 to-amber-700 overflow-hidden">
